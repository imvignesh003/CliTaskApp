...
public class Task {
    ...
    public String toJson() {
        return "{\"id\":\"" + id + "\", \"description\":\"" + description.strip() + "\", \"status\":\"" + status.toString() +
                "\", \"createdAt\":\"" + createdAt.format(DTFORMATTER) + "\", \"updatedAt\":\"" + updatedAt.format(DTFORMATTER) + "\"}";
    }
    ...
    public static Task fromJson(String json) {
        ...
        task.status = status;
        task.createdAt = LocalDateTime.parse(createdAtStr, DTFORMATTER);
        task.updatedAt = LocalDateTime.parse(updatedAtStr, DTFORMATTER);
